...
3. **الكلماتُ ذات القراءتين الصحيحتين ليست في المعجم قصداً** (العِلْم/العَلَم ·
   شُكْرًا/شُكْراً — وموضع التنوين قبل الألف أو بعدها كلاهما شائع).
...
STEMS = {
    ...
    "محمد": "مُحَمَّد", "عمر": "عُمَر", "مريم": "مَرْيَم", "سارة": "سَارَة",
    "لينا": "لِينَا", "يوسف": "يُوسُف", "أحمد": "أَحْمَد", "عائشة": "عَائِشَة",
    # المدرسة
    "المعلم": "الْمُعَلِّم", "المعلمة": "الْمُعَلِّمَة", "معلم": "مُعَلِّم",
