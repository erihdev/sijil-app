...
# -*- coding: utf-8 -*-
"""
نجوم المدرسة — تفتيشُ صحّة التشكيل، لا مطابقةِ الحروف.
...
3. **الكلماتُ ذات القراءتين الصحيحتين ليست في المعجم قصداً**، وكلٌّ منها خرج بعد أن
   أبلغت الأداة عنه خطأً: العِلْم/العَلَم · عُمَر الاسم/عَمَّرَ الفعل · مُعَلِّم/مَعْلَم
   · لِينَا الاسم/لَيِّناً الصفة · الْكِتَاب/الْكُتَّاب مدرسةُ التحفيظ
   · شُكْرًا/شُكْراً (موضع التنوين قبل الألف أو بعدها كلاهما صحيح).
4. **و‍--fix لا يلمس صورةً مختلَفاً فيها**: يمسح المعجم على الدروس أولاً، فما ظهر بجسمين
   أو أكثر يُعدّ مشتبهاً لا مخطئاً، فيُعرض للمراجعة ولا يُصحَّح آلياً ويخرج بالرمز 2.
   هذا الحرس أمسك «الْكُتَّاب» في so6t1w11 ومنع تحويلها إلى «الْكِتَاب».
