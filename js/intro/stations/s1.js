...
(function () {
  ...
  var station = {
    ...
    /* نقطة وسطى ترفع الأفق قليلاً حتى لا يملأ الرمل ثلث الكادر السفلي عند التسليم.
       mpos/mlook (الجوال العمودي فقط، fov 62 + رفع 0.4 من core): الكاميرا أخفض قليلاً والهدف أعلى
       فتميل الكاميرا للأعلى: السماء خلف نص العنوان (الثلث العلوي)، اللوحة في الحزام الأوسط (≈39%–56%)،
       السور والطابور تحتها، والأرض ≤ ثلث الكادر. الكشف الافتتاحي يبقى (اللوحة تملأ الشاشة عند t=0). */
    cam: [
      /* العمودي t=0: الكاميرا أبعد (z 11) والهدف أعلى قليلاً حتى تكون اللوحة عند p=0.2 ≤ 84% من العرض غير مقطوعة
         وقمّة الجملون تحت الثلث العلوي؛ t=0.72/1: هدف أعلى قليلاً (ميل للأعلى) وكاميرا أقرب فتنكمش الأرض الرملية
         أسفل الكادر إلى ≈ 22% وتبقى اللوحة داخل الحزام (≈44%–60%) */
      { t: 0.0, pos: [0, 3.6, 3.2], look: [0, 5.2, 0], mpos: [0, 3.5, 11], mlook: [0, 5.6, 0] },
      { t: 0.72, pos: [0, 4.2, 17], look: [0, 3.3, -2], mpos: [0, 2.9, 18.5], mlook: [0, 5.5, -1] },
      { t: 1.0, pos: [0, 4.8, 22], look: [0, 2.6, -2], mpos: [0, 2.8, 18.5], mlook: [0, 5.4, -1.5] }
    ],
